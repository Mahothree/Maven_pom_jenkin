...
public class TC_007_productdetails {
	...
	prdt.prdt1();
	  ...
	  Set<String> s=driver.getWindowHandles();
		...
		prdt.prdt_prize();
		System.out.println(prdt.prize.getText());
		
		prdt.prdt_description();
		System.out.println(prdt.prdt_desc.getText());

		prdt.prdt_review();
		Assert.assertTrue(prdt.seemorereviews.isDisplayed(),"more review available");
